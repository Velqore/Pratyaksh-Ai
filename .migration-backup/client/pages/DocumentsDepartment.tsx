                  ...
                  {isAnalyzing && (
                    <div className="space-y-2">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">
                        ...
                        {analysisProgress >= 25 &&
                          analysisProgress < 50 &&
                          "Extracting handwriting characteristics..."}
                        {analysisProgress >= 50 &&
                          analysisProgress < 75 &&
                          "Analyzing for forgery indicators..."}
                        {analysisProgress >= 75 &&
                          "Detecting disguised writing patterns..."}
                      </div>
                    </div>
                  )}
                </div>
                                    ...
                                    <>
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="text-center p-4 bg-white dark:bg-gray-700 rounded border">
                                          <div
                                            className={`text-3xl font-bold ${documentFeatures.comparisonAnalysis.matchScore >= 70 ? "text-green-600" : documentFeatures.comparisonAnalysis.matchScore >= 50 ? "text-yellow-600" : "text-red-600"}`}
                                          >
                                            {
                                              documentFeatures
                                                .comparisonAnalysis.matchScore
                                            }
                                            %
                                          </div>
                                          <div className="text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <div className="p-4 bg-white dark:bg-gray-700 rounded border">
                                          ...
                                          <div
                                            className={`text-sm font-medium ${documentFeatures.comparisonAnalysis.matchScore >= 70 ? "text-green-600" : documentFeatures.comparisonAnalysis.matchScore >= 50 ? "text-yellow-600" : "text-red-600"}`}
                                          >
                                            {
                                              documentFeatures
                                                .comparisonAnalysis
